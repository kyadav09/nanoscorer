# nanoscorer Design Spec & Post-Mortem

The "why" for each design choice below is written for an engineering audience looking at hardware-aware execution, not just basic correctness.
